    ...
    <div id="about">
        <div class="default-content pt-4 pb-5">
            <div class="custom-container">
                <div class=" pb-4">
                    <h1 class="text-center" style="color: #ff6b35;font-family:'Playfair Display', serif;font-weight:500">Contact <snap style="color:green"> Us</span></h1>
                </div>
    ...
    <div class="contact-form-area mb-2 flex-grow-1">
      ...
      <form enctype="multipart/form-data" method="POST" id="contactUsForm" action="javascript:">
            ...
            <div class="row">
              ...
              <div class="col-md-6 pt-4 view-button">
                <button type="button" class="btn default-btn btn-block font-weight-bold"
                  style="background: #ff6b35; border:1px solid white"
        ...
        <div class="view-button">
          <button class="default-btn" id="submitButton" type="submit" style="background: #ff6b35; border:1px solid white">Submit</button>
        </div>
      </form>
    </div>
  </div>
